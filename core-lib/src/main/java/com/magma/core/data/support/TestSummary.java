...
public class TestSummary {
    ...
    private List<Map<String, Map<String, Map<String, List<TestCard>>>>> deviceTestResult;
    ...
    public List<Map<String, Map<String, Map<String, List<TestCard>>>>> getDeviceTestResult() {
        return deviceTestResult;
    }

    public void setDeviceTestResult(List<Map<String, Map<String, Map<String, List<TestCard>>>>> deviceTestResult) {
