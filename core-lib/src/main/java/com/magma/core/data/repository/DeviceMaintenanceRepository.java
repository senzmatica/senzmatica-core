...
@Repository
public interface DeviceMaintenanceRepository extends MongoRepository<DeviceMaintenance, String> {
    ...
    List<DeviceMaintenance> findByDeviceIdAndNumberAndTimeBetweenOrderByTimeAsc(String deviceId, Integer number, DateTime start, DateTime end);

    List<DeviceMaintenance> findByDeviceIdAndNumberAndTimeBetweenOrderByTimeDesc(String deviceId, Integer number, DateTime start, DateTime end);
...
//    List<Sensor> findByDeviceIdAndNumberOrderByTimeDesc(String deviceId, Integer number);
    ...
    List<DeviceMaintenance> findByDeviceIdAndCodeAndTimeBetweenOrderByTimeAsc(String deviceId, String code, DateTime startDateTime, DateTime endDateTime);

    List<DeviceMaintenance> findTop240ByDeviceIdAndCodeOrderByTimeDesc(String deviceId, String code);
}
