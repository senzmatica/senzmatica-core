...
public class Sensor {
    ...
    public Sensor(String deviceId, Integer number, SensorCode code, DateTime time, String value, Map<Integer, Shift> shiftMap) {
        this.deviceId = deviceId;
        this.number = number;
        this.code = code;
        this.time = time;
    ...
    public Sensor(String deviceId, Integer number, SensorCode code, DateTime time, String value, Map<Integer, Shift> shiftMap, String flag) {
        this.deviceId = deviceId;
        this.number = number;
        this.code = code;
        this.time = time;
