...
public class TestCase {
    ...
    private List<String> subTestCasesIdList = new ArrayList<>();
    ...
    public TestCase(Integer batchNumber, TestResult status, String mainTestTitle, Boolean isDefault, List<String> devices) {
        this.batchNumber = batchNumber;
        this.status = status;
        this.mainTestTitle = mainTestTitle;
        this.isDefault = isDefault;
    ...
    public List<String> getSubTestCasesIdList() {
        return subTestCasesIdList;
    }

    public void setSubTestCasesIdList(List<String> subTestCasesIdList) {
        this.subTestCasesIdList = subTestCasesIdList;
    }
}
