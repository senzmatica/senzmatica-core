...
public class DeviceMaintenance {
    ...
    public DeviceMaintenance(String deviceId, Integer number, String code, DateTime time, String value) {
    ...
    public DeviceMaintenance(String deviceId, Integer number, String code, DateTime time, String value, Map<Integer, Shift> shiftMap) {
        this.deviceId = deviceId;
        this.number = number;
        this.code = code;
        this.time = time;
    ...
    public DeviceMaintenance(String deviceId, Integer number, String code, DateTime time, String value, String flag) {
        this.deviceId = deviceId;
        this.number = number;
        this.code = code;
        this.time = time;
    ...
    public DeviceMaintenance(String deviceId, Integer number, String code, DateTime time, String value, Map<Integer, Shift> shiftMap, String flag) {
        this.deviceId = deviceId;
        this.number = number;
        this.code = code;
        this.time = time;
