...
public class SubTestCase {
    ...
    private Map<String, Map<String, String>> subTestCaseTimeBetween = new HashMap<>();

    public SubTestCase() {
    }

    public SubTestCase(Integer batchNumber, TestResult status, String subTestTitle, Boolean isDefault, String minVal,
                       String maxVal, String valueType, List<String> devices, DateTime startTime, DateTime endTime,
                       Map<String, Map<String, String>> subTestCaseTimeBetween) {
        this.minVal = minVal;
        this.maxVal = maxVal;
    ...
    public Map<String, Map<String, String>> getSubTestCaseTimeBetween() {
        return subTestCaseTimeBetween;
    }

    public void setSubTestCaseTimeBetween(Map<String, Map<String, String>> subTestCaseTimeBetween) {
        this.subTestCaseTimeBetween = subTestCaseTimeBetween;
    }
}
