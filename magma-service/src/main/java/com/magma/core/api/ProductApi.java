...
public class ProductApi {
    ...
    public MagmaResponse<ProductCore> addProduct(@RequestParam(value = "product") String product, @RequestParam(value = "binFile", required = false) MultipartFile binFile) {
    ...
    public MagmaResponse<List<ProductParameter>> getRemoteConfigurations(@PathVariable("productType") String productType, @PathVariable("deviceCategory") String deviceCategory, @PathVariable("version") String version) {
    ...
    public MagmaResponse<String> addProductsAsUserFavourite(@PathVariable("userId") String userId, @RequestBody List<String> productIds) {
    ...
    public MagmaResponse<String> removeProductsFromUserFavourite(@PathVariable("userId") String userId, @RequestBody List<String> productIds) {
