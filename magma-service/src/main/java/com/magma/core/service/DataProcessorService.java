...
//                sensorMap.put(sensorNumber, sensor);
            ...
            performPropertyData(deviceId, txt, sensorMap, time, flag);
        }
    }

    public void performPropertyData(String deviceId, String txt, Map<Integer, Sensor> sensorMap, DateTime time, String flag) {
    ...
    public Double decode(String propertyCode, Operation operation, Sensor sensor, Kit kit) {

        boolean isMatch = sensor.getCode().equals(propertyCode);
            ...
            case "RL":
                ...
                if (locTem.length >= 2) {
                    ...
                    if (locTem.length > 2) {
                        ...
                        Property property = kit.getProperties().stream().filter(e -> e.getCode() == "A").findFirst().orElse(null);
...
//                return -9999.0;
    ...
    // Double predict(Integer propertyNumber, String propertyCode, Operation operation, List<Sensor> sensors, Kit kit) {

    //     LOGGER.debug("Prediction Started For : {}, with Sensors : {}", propertyCode, sensors);
    //     List<String> mea = Arrays.asList("MEA", "MEA0", "MEA1", "MEA2", "MEA3", "MEA4");
    //     List<String> temps = Arrays.asList("T", "ST");
    ...
    public String handleCodec(Device device, String rawTxt) {
        ...
        if (device.getMagmaCodecId() == null) {
            return rawTxt;
        }
        ...
        if (magmaCodec != null) {
            ...
            if (isCompiledSucessfully) {
                try {
                    ...
                    // payload = "0-T:30;1-H:40"; //dummy payload
                } catch (Exception e) {
